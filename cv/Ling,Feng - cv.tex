...
\begin{longtable}{@{}>{\raggedright}p{0.15\linewidth}
        p{\dimexpr0.85\linewidth-2\tabcolsep-\arrayrulewidth\relax}@{}}
    {2016 - now} & {\bf Graduate Teaching Assistant}, USC (AME 310 Engineering Thermodynamics)\\
...
& Engineering Analytical Dynamics, \emph{Prof.~Firdaus Udwadia}\\
& Incompressible Fluids, \emph{Prof.~Paul Newton}\\
& Engineering Vibration, \emph{Prof.~Bingen Yang}\\
