...
\section{EDUCATION}
\sepline
\begin{longtable}{@{}>{\raggedright}p{0.12\linewidth}
        p{\dimexpr0.88\linewidth-2\tabcolsep-\arrayrulewidth\relax}@{}}
...
\begin{longtable}{@{}>{\raggedright}p{0.12\linewidth}
        p{\dimexpr0.88\linewidth-2\tabcolsep-\arrayrulewidth\relax}@{}}
    {2017 - } & {\bf Research Assistant}, Filament dynamics, supervised by \textit{Prof.~Eva Kanso}\\
    {2016} & {\bf Teaching Assistant}, Engineering Thermodynamics (USC AME 310)\\
	{2013 - 2015} & {\bf Research Assistant}, Center for Space Research at UT Austin\\
...
\begin{longtable}{@{}>{\raggedright}p{0.12\linewidth}
		p{\dimexpr0.88\linewidth-2\tabcolsep-\arrayrulewidth\relax}@{}}
	{2018} & {\bf Instability-driven Oscillations of Active Microfilament}, \emph{Hanliang Guo, Eva Kanso}, \textit{in preparation}\\
\end{longtable}
\vsrk\vsrk
\section{TALKS}
\sepline
\begin{longtable}{@{}>{\raggedright}p{0.12\linewidth}
		p{\dimexpr0.88\linewidth-2\tabcolsep-\arrayrulewidth\relax}@{}}
	{2018} & {\bf APS March of Fluid Dynamics}, Instability-driven Oscillations of Active Microfilament\\
	{2017} & {\bf APS Division of Fluid Dynamics}, Dynamics of Active Microfilaments\\
	{2016} & {\bf Mathematics Undergraduate Student Talks (MUST)}, LS category and its cousins\\
	{2015} & {\bf Directed Reading Program (DRP)}, (co)fiber sequences and $\pi_3(S^2)$, mentored by \textit{Ernest Fontes}\\
	{} & {\bf DRP}, What is persistent homology, mentored by \textit{Ahmad Issa}\\
	{2014} & {\bf DRP}, \v{C}ech cohomology of projective spaces, mentored by \textit{Dr~Yuecheng Zhu}\\
	{} & {\bf DRP}, Classification of Du-val singularities, mentored by \textit{Dr~Yuecheng Zhu}\\
	{2013} & {\bf DRP}, How to blow up double points in an affine plane and why you should do it too, mentored by \textit{Dr~Hendrik Orem}\\
\end{longtable}
\vsrk\vsrk
...
{2017} & Thermodynamics and Statistical Mechanics, \textbf{B+}, \emph{Prof.~Christoph Haselwandter}\\
{} & Incompressible Fluids and Turbulence, \textbf{A}, \emph{Prof.~Mitul Luhar}\\
...
{2015} & Algebra, {\bf B}, \emph{Prof.~Felipe Voloch}\\
