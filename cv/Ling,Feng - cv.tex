...
{\bf Birth Year:} 1992 & {\bf Address:} 1229 W 37 Pl, Los Angeles, CA 90007\\
...
{2016 - now} & {\bf The University of Southern California}, Los Angeles, CA\\
...
\begin{longtable}{@{}>{\raggedright}p{0.15\linewidth}
        p{\dimexpr0.85\linewidth-2\tabcolsep-\arrayrulewidth\relax}@{}}
    {2017 - now} & {\bf Research Assistant}, Filament dynamics, supervised by \textit{Prof.~Eva Kanso}\\
...
{2016}	& {\bf 2D discrete inverse spectral problem}, supervised by \textit{Prof.~Etienne Vouga} and \textit{Prof.~Keenan Crane}\\
 &	reconstructing discrete 2D genus 0 surfaces using only its Laplace-Beltrami spectral data\\
...
{Spring 2017} & Incompressible Fluids, \emph{Prof.~Mitul Luhar}\\

{Fall 2016} & Fokas method (Audit), \emph{Prof.~Athanassios Fokas}\\
& Engineering Analytical Dynamics, \textbf{A}, \emph{Prof.~Firdaus Udwadia}\\
& Incompressible Fluids, \textbf{A-}, \emph{Prof.~Paul Newton}\\
& Engineering Vibration, \textbf{A-}, \emph{Prof.~Bingen Yang}\\

& \textbf{at University of Texas at Austin} \\
    
{Spring 2016} & Kac-Moody Algebras and Groups (Audit), \emph{Prof.~Daniel Allcock}\\
...
{2011 - 2016} & {\bf Coursera, Udacity, and other MOOC experiences}\\
