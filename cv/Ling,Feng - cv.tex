...
\begin{longtable}{@{}>{\raggedright}p{0.15\linewidth}
        p{\dimexpr0.85\linewidth-2\tabcolsep-\arrayrulewidth\relax}@{}}
	& {\bf 2D discrete inverse spectral problem}, supervised by \textit{Prof.~Etienne Vouga} and \textit{Prof.~Keenan Crane}\\
{2016 - now} &	reconstructing discrete 2D genus 0 surfaces using only its Laplace-Beltrami spectral data\\
